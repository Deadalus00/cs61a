...
def roll_dice(num_rolls, dice=six_sided):
    ...
    return_one = False
    while k < num_rolls:
        point_this_time = dice()
        if point_this_time == 1:
            return_one = True
        out += point_this_time
        k += 1
...
def free_bacon(score):
    ...
    if score == 0:
        ...
        k = 1
        while not(pow(10, score) <= pi < pow(10, score + 1)):
            pi -= pi % 10
            pi //= 10
    return pi % 10 + 3        
    # END PROBLEM 2
...
def swine_align(player_score, opponent_score):
    ...
    if min(player_score, opponent_score) == 0:
        ...
        while k < min(player_score, opponent_score): 
            k += 1
...
def pig_pass(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4b
    return 0 > (player_score - opponent_score) >= -2
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            present_strat_zero = strategy0(score0, score1)
            score0 += take_turn(present_strat_zero, score1, dice)
            if not extra_turn(score0, score1):
                who = other(who)
            say = say(score0, score1)
        else:
            present_strat_one = strategy1(score1, score0)
            score1 += take_turn(present_strat_one, score0, dice)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def f(score0, score1):
        ...
        if who == 0:
            ...
            return announce_highest(who, last_score=score0, running_high=highest)
        else:
            ...
            return announce_highest(who, last_score=score1, running_high=highest)
    return f
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    largest_num_rolls = 0
    highest_avg_score = 0
    one_turn_score = make_averaged(roll_dice, trials_count)
    while num_rolls <= 10:
        score_this_time = one_turn_score(num_rolls, dice)
        if score_this_time > highest_avg_score:
            highest_avg_score = score_this_time
            largest_num_rolls = num_rolls
        num_rolls += 1
    return largest_num_rolls
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score + free_bacon(opponent_score), opponent_score):
        return 0
    elif bacon_strategy(score, opponent_score,
                        cutoff, num_rolls) == 0:
        return 0
    return num_rolls
    # END PROBLEM 11
